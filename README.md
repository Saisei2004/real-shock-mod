...
|---|---|
| ![通常プレイ中の接敵](docs/images/re9-normal-play.png) | ![びっくりコマンドのUI](docs/images/ui-startle.png) |
...
![実測データから作成した生体波形](docs/images/biometric-waveforms.svg)

上の波形は、同梱CSVから作った比較用グラフです。ホラー映画、バイオハザード、コンジアム、姿勢変化、あくびなどを混ぜて見て、びっくり判定と誤検知の境界を調整しています。
